> Source: [Pi v0.85.1 / packages/coding-agent/docs/containerization.md](https://github.com/earendil-works/pi/blob/v0.85.1/packages/coding-agent/docs/containerization.md). Copied from the installed package.
...
| --- | --- | --- | --- |
| Gondolin extension | Built-in tools and `!` commands | Local micro-VM isolation while keeping auth on host | See [`examples/extensions/gondolin/`](https://github.com/earendil-works/pi/blob/v0.85.1/packages/coding-agent/examples/extensions/gondolin/). |
...
Use the [example extension](https://github.com/earendil-works/pi/blob/v0.85.1/packages/coding-agent/examples/extensions/gondolin) when you want `pi` on the host but all built-in tools routed into the VM.
...
It is one of the container boundaries [No Built-in Sandbox](pi-security.md#no-built-in-sandbox) points to.
