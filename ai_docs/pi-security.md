> Source: [Pi v0.85.1 / packages/coding-agent/docs/security.md](https://github.com/earendil-works/pi/blob/v0.85.1/packages/coding-agent/docs/security.md). Copied from the installed package.
...
Common patterns are documented in [Containerization](pi-containerization.md):
