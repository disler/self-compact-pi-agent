...
> Source: [Pi v0.85.1 / packages/coding-agent/examples/sdk/10-settings.ts](https://github.com/earendil-works/pi/blob/v0.85.1/packages/coding-agent/examples/sdk/10-settings.ts). Copied from the installed package.
