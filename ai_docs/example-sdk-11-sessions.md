...
> Source: [Pi v0.85.1 / packages/coding-agent/examples/sdk/11-sessions.ts](https://github.com/earendil-works/pi/blob/v0.85.1/packages/coding-agent/examples/sdk/11-sessions.ts). Copied from the installed package.
