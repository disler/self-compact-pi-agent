> Source: [Pi v0.85.1 / packages/coding-agent/docs/settings.md](https://github.com/earendil-works/pi/blob/v0.85.1/packages/coding-agent/docs/settings.md). Copied from the installed package.
...
See [packages.md](pi-packages.md) for package management details.
