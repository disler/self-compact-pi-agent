...
> Source: [Pi v0.85.1 / packages/coding-agent/examples/extensions/tool-override.ts](https://github.com/earendil-works/pi/blob/v0.85.1/packages/coding-agent/examples/extensions/tool-override.ts). Copied from the installed package.
