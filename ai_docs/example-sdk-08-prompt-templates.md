...
> Source: [Pi v0.85.1 / packages/coding-agent/examples/sdk/08-prompt-templates.ts](https://github.com/earendil-works/pi/blob/v0.85.1/packages/coding-agent/examples/sdk/08-prompt-templates.ts). Copied from the installed package.
