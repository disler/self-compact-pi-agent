> Source: [Pi v0.85.1 / packages/coding-agent/docs/quickstart.md](https://github.com/earendil-works/pi/blob/v0.85.1/packages/coding-agent/docs/quickstart.md). Copied from the installed package.
...
See [Providers](pi-providers.md) for all supported providers, environment variables, and cloud-provider setup.
...
- [Using Pi](pi-usage.md) - interactive mode, slash commands, sessions, context files, and CLI reference.
- [Providers](pi-providers.md) - authentication and model setup.
- [Settings](pi-settings.md) - global and project configuration.
- [Keybindings](pi-keybindings.md) - shortcuts and customization.
- [Pi Packages](pi-packages.md) - install shared extensions, skills, prompts, and themes.

Platform notes: [Windows](pi-windows.md), [Termux](pi-termux.md), [tmux](pi-tmux.md), [Terminal setup](pi-terminal-setup.md), [Shell aliases](pi-shell-aliases.md).
