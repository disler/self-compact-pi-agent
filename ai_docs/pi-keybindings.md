> Source: [Pi v0.85.1 / packages/coding-agent/docs/keybindings.md](https://github.com/earendil-works/pi/blob/v0.85.1/packages/coding-agent/docs/keybindings.md). Copied from the installed package.
