...
> Source: [Pi v0.85.1 / packages/coding-agent/examples/extensions/send-user-message.ts](https://github.com/earendil-works/pi/blob/v0.85.1/packages/coding-agent/examples/extensions/send-user-message.ts). Copied from the installed package.
