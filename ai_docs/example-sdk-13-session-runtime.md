...
> Source: [Pi v0.85.1 / packages/coding-agent/examples/sdk/13-session-runtime.ts](https://github.com/earendil-works/pi/blob/v0.85.1/packages/coding-agent/examples/sdk/13-session-runtime.ts). Copied from the installed package.
