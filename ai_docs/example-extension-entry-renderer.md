...
> Source: [Pi v0.85.1 / packages/coding-agent/examples/extensions/entry-renderer.ts](https://github.com/earendil-works/pi/blob/v0.85.1/packages/coding-agent/examples/extensions/entry-renderer.ts). Copied from the installed package.
