...
> Source: [Pi v0.85.1 / packages/coding-agent/examples/sdk/03-custom-prompt.ts](https://github.com/earendil-works/pi/blob/v0.85.1/packages/coding-agent/examples/sdk/03-custom-prompt.ts). Copied from the installed package.
