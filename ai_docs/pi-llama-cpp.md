> Source: [Pi v0.85.1 / packages/coding-agent/docs/llama-cpp.md](https://github.com/earendil-works/pi/blob/v0.85.1/packages/coding-agent/docs/llama-cpp.md). Copied from the installed package.
