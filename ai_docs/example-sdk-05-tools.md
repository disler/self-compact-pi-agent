...
> Source: [Pi v0.85.1 / packages/coding-agent/examples/sdk/05-tools.ts](https://github.com/earendil-works/pi/blob/v0.85.1/packages/coding-agent/examples/sdk/05-tools.ts). Copied from the installed package.
