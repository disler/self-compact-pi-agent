...
> Source: [Pi v0.85.1 / packages/coding-agent/examples/extensions/trigger-compact.ts](https://github.com/earendil-works/pi/blob/v0.85.1/packages/coding-agent/examples/extensions/trigger-compact.ts). Copied from the installed package.
