> Source: [Pi v0.85.1 / packages/coding-agent/docs/terminal-setup.md](https://github.com/earendil-works/pi/blob/v0.85.1/packages/coding-agent/docs/terminal-setup.md). Copied from the installed package.
