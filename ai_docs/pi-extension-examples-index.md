> Source: [Pi v0.85.1 / packages/coding-agent/examples/extensions/README.md](https://github.com/earendil-works/pi/blob/v0.85.1/packages/coding-agent/examples/extensions/README.md). Copied from the installed package.
...
| `rpc-demo.ts` | Exercises all RPC-supported extension UI methods; pair with [`examples/rpc-extension-ui.ts`](https://github.com/earendil-works/pi/blob/v0.85.1/packages/coding-agent/examples/rpc-extension-ui.ts) |
...
See [docs/extensions.md](pi-extensions.md) for full documentation.
