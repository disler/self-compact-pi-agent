...
> Source: [Pi v0.85.1 / packages/coding-agent/examples/sdk/09-api-keys-and-oauth.ts](https://github.com/earendil-works/pi/blob/v0.85.1/packages/coding-agent/examples/sdk/09-api-keys-and-oauth.ts). Copied from the installed package.
