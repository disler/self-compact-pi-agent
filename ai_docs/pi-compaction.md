> Source: [Pi v0.85.1 / packages/coding-agent/docs/compaction.md](https://github.com/earendil-works/pi/blob/v0.85.1/packages/coding-agent/docs/compaction.md). Copied from the installed package.
...
See [custom-compaction.ts](example-extension-custom-compaction.md) for a complete example using a different model.
