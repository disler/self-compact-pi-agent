> Source: [Pi v0.85.1 / packages/coding-agent/docs/sdk.md](https://github.com/earendil-works/pi/blob/v0.85.1/packages/coding-agent/docs/sdk.md). Copied from the installed package.
...
See [examples/sdk/](pi-sdk-examples-index.md) for working examples from minimal to full control.
...
> See [examples/sdk/02-custom-model.ts](example-sdk-02-custom-model.md)
...
> See [examples/sdk/09-api-keys-and-oauth.ts](example-sdk-09-api-keys-and-oauth.md)
...
> See [examples/sdk/03-custom-prompt.ts](example-sdk-03-custom-prompt.md)
...
> See [examples/sdk/05-tools.ts](example-sdk-05-tools.md)
...
Extensions can register tools, subscribe to events, add commands, and more. See [extensions.md](pi-extensions.md) for the full API.
...
> See [examples/sdk/06-extensions.ts](example-sdk-06-extensions.md) and [docs/extensions.md](pi-extensions.md)
...
> See [examples/sdk/04-skills.ts](example-sdk-04-skills.md)
...
> See [examples/sdk/07-context-files.ts](example-sdk-07-context-files.md)
...
> See [examples/sdk/08-prompt-templates.ts](example-sdk-08-prompt-templates.md)
...
> See [examples/sdk/11-sessions.ts](example-sdk-11-sessions.md) and [Session Format](pi-session-format.md)
...
> See [examples/sdk/10-settings.ts](example-sdk-10-settings.md)
...
See [RPC documentation](pi-rpc.md) for the JSON protocol.
...
For extension types, see [extensions.md](pi-extensions.md) for the full API.
