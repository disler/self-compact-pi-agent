...
> Source: [Pi v0.85.1 / packages/coding-agent/examples/sdk/02-custom-model.ts](https://github.com/earendil-works/pi/blob/v0.85.1/packages/coding-agent/examples/sdk/02-custom-model.ts). Copied from the installed package.
