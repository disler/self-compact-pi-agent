> Source: [Pi v0.85.1 / packages/coding-agent/docs/sessions.md](https://github.com/earendil-works/pi/blob/v0.85.1/packages/coding-agent/docs/sessions.md). Copied from the installed package.
...
For parsers, extensions, SDK usage, and the full SessionManager API, see [Session Format](pi-session-format.md).
