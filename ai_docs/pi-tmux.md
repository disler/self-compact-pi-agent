> Source: [Pi v0.85.1 / packages/coding-agent/docs/tmux.md](https://github.com/earendil-works/pi/blob/v0.85.1/packages/coding-agent/docs/tmux.md). Copied from the installed package.
