> Source: [Pi v0.85.1 / packages/coding-agent/docs/windows.md](https://github.com/earendil-works/pi/blob/v0.85.1/packages/coding-agent/docs/windows.md). Copied from the installed package.
